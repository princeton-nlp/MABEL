...
Before training, make sure that the [counterfactually-augmented data](https://drive.google.com/file/d/19deluERQrAI81ETRbySyZ_7ilKYt78DD/view?usp=sharing), processed from the SNLI and MNLI datasets, is downloaded and stored under the `training` directory as `entailment_data.csv`. 
